...
For more information, see the secure-by-design [principles][1] and [policy][2] guidelines.

Teams **MUST**:

- define all environments in code using Infrastructure as Code (IaC)
- use only approved data classifications in each environment
...
- **Lightweight**: Fast to provision, low-cost, not production-scale. Typical short-lived or ephemeral. Used for development, testing, and training.
...
- **MUST** provide centralised logging and monitoring, integrated with the Security Operations Centre (SOC)
...
| ENV-3 | Data usage | Correct data classification in each | Low grade live data in non-prod | Sensitive live data in non-prod |
...
[1]: https://www.security.gov.uk/policy-and-guidance/secure-by-design/principles/
[2]: https://www.security.gov.uk/policy-and-guidance/secure-by-design/policy/
